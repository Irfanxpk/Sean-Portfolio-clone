      ...
      <div className="absolute bottom-0 left-[20px]">
        <div class="max-w-xl space-y-2">
          ...
          <p class="text-sm text-gray-500 leading-relaxed text-[11px]">
            “Sean Chasing Three Sheep” as the title suggests, illustrates the
            artist chasing three sheep. Lin, currently a Resident Alien living
            in the United States of America, runs in place with a hopeful facade
            and watches as his dreams slip away. A seemingly light hearted and
            humorous narrative, disguises a deeper reality and fear of
            unemployment, immigration status, and uninspiring design.
          </p>
        </div>
      </div>
    </section>
